        ...
        {step === 4 && (
          <div className="animate-fade-in-up text-center">
            ...
            <button
              ...
              className="mt-8 rounded-full bg-violet-700 px-8 py-3.5 text-base font-semibold text-white shadow-md shadow-violet-200 transition hover:-translate-y-0.5 hover:bg-violet-800"
            >
              Start exploring
            </button>
          </div>
